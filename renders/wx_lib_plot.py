...
"""
NOTE: This is a modified version of the standard wxPython module. It removes
deprecated Numeric references, which are not available in the 64 bit Windows
version of the library. This may be fixed in the future, in which case the
standard wx.lib.plot should be used. This version also trims off the stand-alone
demo code. - DRS, 20140916

Occurrences of '== None' have been replaced with 'is None' to heed a Numpy
warning about future changes. - DRS, 20150318
...
# Needs NumPy
try:
    # NOTE: numpy.oldnumeric is not available in 64b Windows version!
...
class PlotCanvas(wx.Panel):
    ...
    def _Draw(self, graphics, xAxis = None, yAxis = None, dc = None):
        ...
        # NOTE: This is my change to heed a Numpy warning:
