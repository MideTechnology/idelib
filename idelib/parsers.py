...
class ChannelDataArrayBlock(BaseDataBlock):
    """ Wrapper for ChannelDataArrayBlock elements, which features additional data
...
class ChannelDataArrayBlockParser(SimpleChannelDataBlockParser):
